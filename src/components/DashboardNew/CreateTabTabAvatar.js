...
import CreateTabNFT from './CreateTabNFTLaunchpad';
...
import { getallAvatarYes, getallLaunchpadYes, getNFTDetailsByAddressTypeSale } from '../../awsdatafile';
...
const CreateTabTab=()=>{
    ...
    const dbcall1155=async()=>{                
        ...
        let createdNft = await getallAvatarYes()  
        // if(createdNft)
    ...
    return(        
                    ...
                    {/* <Tabs defaultActiveKey="NFT" id="uncontrolled-tab-example" className='dashboard-tabs'>                     */}
                        {/* <Tab eventKey="NFT" title="NFT"> */}
                            ...
                            <>                                
                                {getImgNFT1155.map((x, index) => {  
                                    if(x.buyerAddress  === localStorage.getItem("EAWalletAddress"))                 
                                    return( 
                                    <CreateTabNFT x={x} />
                                    )
                                })}
