...
import { createActivityTable, getuserDetailsbywallet, putByPrice, putBySale, updateLandByPrice } from '../../awsdatafile';
    ...
    const setpricedb=async(b)=>{        
        ...
        try {  
            ...
            try{
                ...
                toast.success(`Land Price Updated Successfully`,{autoClose: 5000});            
                    //await saledb()
                    handleHideLoad()
                    await done();
            }catch(error){
    ...
    return(           
                ...
                <Card className='card-dash p-3 d-block border-0'>
                    ...
                    <h5 className='mb-2'>{x.name} <br />
                        ...
                        <>                                             */}
                        <h6 className='mb-2'>Price</h6><h5 className='d-flex mb-3 align-items-center'>
