...
import { getCreatedEvents, getCreatedEventsNotApproved, updatecreateevent } from '../../firebaseuploadconfig';


const TopCollectionsNFTN = () => {
    let history=useHistory();
    useEffect(() => {
        document.title = "DivineDimension | Approve Created Events"
    }, [])    
    ...
    const fetchimages = async() =>{
        if(localStorage.getItem("EAWalletAddress")  === null || localStorage.getItem("EAWalletAddress")  === "" || localStorage.getItem("EAWalletAddress")  === " " || localStorage.getItem("wallet") === undefined || localStorage.getItem("EAWalletAddress") === ''){
           ...
           let createdevent =  await getCreatedEventsNotApproved();
            ...
            <ToastContainer position='bottom-right' draggable = {false} transition={Zoom} autoClose={4000} closeOnClick = {false}/>        
                <div className='nft-tabs'>
                    ...
                    <Tabs defaultActiveKey="all" id="uncontrolled-tab-example" className='dashboard-tabs'>
                        <Tab eventKey="all" title="UnApproved Events">
                           ...
                           <br/>
                            <div className='card-img text-center mb-2'>                                            
                                    ...
                                    {localStorage.getItem("EAWalletAddress") === "0x76e71b82ad335f9699e9f167a147ff9a26c2270abfd3b4b3decf245b96dd8920"?
                                    (<>
                                    <center>  <Button onClick={()=>approve(r)}>Approve</Button><br/></center>
                                    </>):(<>
                                    </>)}  
