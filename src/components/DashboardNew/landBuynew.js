...
const CreateTab =({x})=>{
    ...
    const setpricedb=async(b)=>{ 
        ...
        // else{                          
        handleShowLoad()             
        toast.info(" Buying the land is in progress",{autoClose:5000});                         
        try {  
    ...
    return(           
                ...
                <Card className='card-dash p-3 d-block border-0'>
                    ...
                    <h5 className='mb-2'>{x.name} <br />
                                        ...
                                        <br/>
                                        <h6 className='mb-2'> [{x.latitude ? x.latitude : "0"},{x.longitude ? x.longitude : "0"} ] </h6>
                        ...
                        <h6 className='mb-2'>Price : {x.price ? (x.price/1000000000000000000) : "0"} DIME</h6><h5 className='d-flex mb-3 align-items-center'>
