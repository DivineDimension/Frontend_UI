    ...
    const setpricedb=async(b)=>{ 
        ...
        try {  
            ...
            const transaction = {
                ...
                arguments: ["0xc02622b215e72aa3dc4bd74b5e39b33f4c4967ae26e698e45b6f70fc639b666",b.walletAddress,b.walletAddress,b.name,b.name,"0x64da516a577afd007a7aba4c7dba7dd19bbae5dd9e16a435f6b3df024c12d270",10000,0,1],
            ...
            try{
                ...
                // await createActivityTable(localStorage.getItem('EAWalletAddress'),"Update price", pooladdressfinal,transaction2Hash,"Royalty-NFT")
                toast.success(`Avatar purchaed Successfully`,{autoClose: 5000});            
                    //await saledb()
                    handleHideLoad()
                    await done();
            }catch(error){
                ...
                <Card className='card-dash p-3 d-block border-0'>
                    ...
                    <h5 className='mb-2'>{x.name} <br />
                        ...
                        {/* {dbalance === "" || dbalance === null || dbalance === undefined || dbalance === 0 ||dbalance === "0" ? (<>
                            ...
                            <ButtonLoad loading={loader} variant="blue" className='w-100' onClick={()=>{setpricedb(x)}}>Buy Avatar </ButtonLoad>                                        
{/* 
                        </>)}                                    
